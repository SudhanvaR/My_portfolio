...
export const ContactSection = () => {
	return (
		<section id="contact" className="relative py-20 px-4 overflow-hidden">
			{/* ✅ Background Image (grayscale only for image) */}
			<div
			...
			<div className="max-w-4xl mx-auto">
				<motion.div
					...
					viewport={{ once: true }}
					className="relative p-8 rounded-2xl overflow-hidden backdrop-blur-lg border border-gray-800 bg-[#161B22]"
				>
					...
					<div className="relative z-10">
						...
						<div className="font-mono">
							...
							<motion.a
								href="mailto:sudhanvar2001@gmail.com"
							...
							<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4">
								...
								>
									...
									<div>
										...
										<p className="text-sm text-gray-400">@SudhanvaR</p>
									</div>
								</motion.a>
								<motion.a
									href="https://www.linkedin.com/in/sudhanva-ramesh-678505214/"
									whileHover={{ scale: 1.05 }}
									className="flex items-center gap-3 px-4 py-3 bg-gray-800/50 rounded-lg hover:bg-gray-700/50 transition-colors border border-gray-700/50 group"
								>
									<div className="p-2 bg-gray-700/50 rounded-lg group-hover:bg-gray-600/50 transition-colors">
									...
									<div>
										...
										<p className="text-sm text-gray-400">Sudhanva R</p>
									</div>
								</motion.a>
								<motion.a
									href="https://leetcode.com/u/Sudhanva_lm10/"
									whileHover={{ scale: 1.05 }}
									className="flex items-center gap-3 px-4 py-3 bg-gray-800/50 rounded-lg hover:bg-gray-700/50 transition-colors border border-gray-700/50 group"
								>
									<div className="p-2 bg-gray-700/50 rounded-lg group-hover:bg-gray-600/50 transition-colors">
									...
									<div>
										<p className="font-semibold text-gray-200">LeetCode</p>
